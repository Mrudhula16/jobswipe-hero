                ...
                <>
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                      ...
                      <Button 
                        ...
                        size="sm" 
                        className="rounded-full"
                        onClick={() => handlePreferenceChange('job_title', 'Interface Designer')}
                      >
                        Interface Designer
                      </Button>
                      <Button 
                        ...
                        size="sm" 
                        className="rounded-full"
                        onClick={() => handlePreferenceChange('job_title', 'Interaction Designer')}
                      >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <Button 
                        variant={jobPreferences.industries?.includes('e-commerce') ? "secondary" : "outline"} 
                        size="sm" 
                        className="rounded-full"
                        onClick={() => toggleArrayPreference('industries', 'e-commerce')}
                      >
                        E-commerce
                      </Button>
                      <Button 
